...
class PrimitivInfo:
    def __init__(self, window, primitv_type:str="test_type",primitiv_name:str="test"):
        ...
        self.icon.setStyleSheet("background-color: rgb(255,255,255); margin:0px; border:2px solid rgb(0, 0, 0); ")
        ...
        self.buuton_create.setStyleSheet("background-color: rgb(255,255,255); margin:0px; border:2px solid rgb(0, 0, 0); ")
        self.buuton_delete.setFixedWidth(32)
        self.buuton_delete.setFixedHeight(34)
        self.buuton_delete.setStyleSheet("background-color: rgb(255,0,0); margin:0px; border:2px solid rgb(0, 0, 0); ")
