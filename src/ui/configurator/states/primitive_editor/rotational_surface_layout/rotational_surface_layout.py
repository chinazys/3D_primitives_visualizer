...
from primitives.rotate_surface.rotate_surface import RotateSurface
...
class RotationalSurfaceLayout:
    """A layout for configuring a rotational surface primitive.

    - Attributes:
        - layout (QVBoxLayout): The main layout for the rotational surface layout.
    ...
    - Methods:
        - __init__(initial_primitive): Initialize a RotationalSurfaceLayout object.
        - get_primitive() -> RotateSurface: Get the configured rotational surface primitive.
    ...
    def get_primitive(self):
        try:
            ...
            return RotateSurface(curve, point, vector)
        except:
            return None